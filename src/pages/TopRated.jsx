  ...
  return (
    <div className="bg-stone-950 min-h-screen">
      <div className="container mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Top Rated Movies</h1>
          <p className="text-gray-400 text-lg">The highest rated movies of all time</p>
        </div>
        ...
        {!hasMore && movies.length > 0 && (
          <div className="text-center py-8">
            <div className="text-gray-400 text-lg">You've seen all top rated movies! 🎬</div>
          </div>
        )}
      </div>
